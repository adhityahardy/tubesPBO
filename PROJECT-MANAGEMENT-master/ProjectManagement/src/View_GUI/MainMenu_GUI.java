...
//        view = (CardLayout) jPanel1.getLayout();
    ...
    private void initComponents() {
        ...
        Panel_Admin.setBackground(new java.awt.Color(204, 0, 0));
    ...
    private void btnProyekActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProyekActionPerformed
        if (btnProyek.isSelected()) {
            panelLayout.add(ProyekMenu, "Proyek");
            view.show(panelLayout, "Proyek");
            SwingUtilities.updateComponentTreeUI(this);
            this.repaint();
            btnClient.setEnabled(false);
            btnManajer.setEnabled(false);
            btnProgrammer.setEnabled(false);
            btnProyek.setBackground(Color.WHITE);
        } else {
            panelLayout.removeAll();
            SwingUtilities.updateComponentTreeUI(this);
            this.repaint();
            btnClient.setEnabled(true);
            btnManajer.setEnabled(true);
            btnProgrammer.setEnabled(true);
            btnProyek.setBackground(new Color(204, 204, 204));
        }
    ...
    private void btnManajerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManajerActionPerformed
        if (btnManajer.isSelected()) {
            panelLayout.add(ManajerMenu, "Manajer");
            view.show(panelLayout, "Manajer");
            SwingUtilities.updateComponentTreeUI(this);
            this.repaint();
            btnClient.setEnabled(false);
            btnProyek.setEnabled(false);
            btnProgrammer.setEnabled(false);
            btnManajer.setBackground(Color.WHITE);
        } else {
            panelLayout.removeAll();
            SwingUtilities.updateComponentTreeUI(this);
            this.repaint();
            btnClient.setEnabled(true);
            btnProyek.setEnabled(true);
            btnProgrammer.setEnabled(true);
            btnManajer.setBackground(new Color(204, 204, 204));
        }
    ...
    private void btnProgrammerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProgrammerActionPerformed
        if (btnProgrammer.isSelected()) {
            ...
            btnManajer.setEnabled(false);
            btnClient.setEnabled(false);
            btnProgrammer.setBackground(Color.WHITE);
        } else {
            panelLayout.removeAll();
            SwingUtilities.updateComponentTreeUI(this);
            this.repaint();
            ...
            btnProyek.setEnabled(true);
            btnClient.setEnabled(true);
            btnProgrammer.setBackground(new Color(204, 204, 204));
